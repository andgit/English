...
<%
//tutaj nie moze byc mozliwosci edycji!

int member_user_id = Integer.parseInt((String)request.getAttribute("member_user_id"));
...
<%
if(member_user_id >= 0) {
 	List<String> userContainer = UsersWorker.GetUserAndAccount(member_user_id);
